...
function Logger:PlaySound()
	Handle(function()
		...
		task.wait(self.Selected.TimeLength-self.Sound.TimePosition)
		self.Sound:Destroy()
...
function Logger:CopyProperties()
	Handle(function()
		self.Lines = {
			...
			`Sound:Play()`;
			"";
			`task.wait(Sound.TimeLength-Sound.TimePosition)`;
			`Sound:Destroy()`;
		}
        ...
        task.spawn(function()
            Handle(function()
                ...
                while Logger.SoundPreviewToggle == true do
                    ...
                    local TimeLength = tonumber(Logger.Selected.TimeLength) or 1
                    local Strength = 0
